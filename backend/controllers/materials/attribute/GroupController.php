...
use Yii;
use common\models\search\materials\attribute\AttributeGroup as AttributeGroupSearch;
    ...
    public function actions()
    {
        return ArrayHelper::merge(parent::actions(), [
            'edit' => [                                       // identifier for your editable column action
                ...
                'modelClass' => AttributeGroup::className(),                // the model for the record being edited
...
//                 'checkAccess' => function($action, $model) {}
    ...
    public function actionCreate($copy_id = null)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Группа атрибутов успешно сохранена');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Группа атрибутов успешно сохранёна');
            return $this->checkSubmitType(Yii::$app->request->post(), $model);
        }
